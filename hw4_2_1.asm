extrn  year:near;申明year是调用其他模块的，near是类型
extrn  store:near;申明store是调用其他模块的，near是类型
extrn  output:near;申明output是调用其他模块的，near是类型
extrn  blank:near;申明blank是调用其他模块的，near是类型
data segment
     ;以下是表示21年的21个字符串
